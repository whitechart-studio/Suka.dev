...
- Use cross-platform filesystem, path, process, and shell abstractions. Avoid hardcoded POSIX separators, Unix shell commands, or Linux-only watcher assumptions.
...
- Windows-style and POSIX-style path normalization where paths affect claims, conflicts, config, or file watching
